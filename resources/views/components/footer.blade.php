<footer class="bg-[#0047ab] text-white">
    <div class="max-w-7xl mx-auto px-8 py-14">
        ...
        <div class="grid md:grid-cols-3 gap-10 items-start">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-200 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white transition">Kendaraan</a></li>
                    <li><a href="#" class="hover:text-white transition">Simulasi Kredit</a></li>
        ...
        <!-- LINE -->
        <div class="border-t border-white/20 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
